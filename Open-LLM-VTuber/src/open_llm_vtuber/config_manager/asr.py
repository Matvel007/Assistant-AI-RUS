...
class GigaAMOnnxConfig(I18nMixin):
    """Configuration for GigaAM ONNX ASR via onnx-asr."""
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        "model_name": Description(
            en="Name of the GigaAM model on Hugging Face (e.g., 'gigaam-v3-e2e-ctc')",
            zh="Hugging Face 上的 GigaAM 模型名称（例如 'gigaam-v3-e2e-ctc'）",
        ),
        "device": Description(
...
class ASRConfig(I18nMixin):
    ...
    gigaam_onnx_asr: Optional[GigaAMOnnxConfig] = Field(None, alias="gigaam_onnx_asr")
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "gigaam_onnx_asr": Description(
            en="Configuration for GigaAM ONNX ASR", zh="GigaAM ONNX ASR 配置"
        ),
